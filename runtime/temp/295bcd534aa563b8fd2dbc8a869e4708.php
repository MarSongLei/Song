<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"G:\shop\tp5\public/../application/admin\view\item\list.html";i:1506336174;s:63:"G:\shop\tp5\public/../application/admin\view\common\header.html";i:1506003141;s:61:"G:\shop\tp5\public/../application/admin\view\common\left.html";i:1506336174;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加链接" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('Item/add'); ?>'"><i class="fa fa-plus"></i>
                    Add
                </button>
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">1</td>
                                            <td align="center">
                                                <a href="<?php echo url('Links/edit',array('id'=>1)); ?>"
                                                   class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>

                                                <a href="#"
                                                   onClick="warning('确实要删除吗', '<?php echo url('Links/del',array('id'=>1)); ?>')"
